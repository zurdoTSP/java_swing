...
public class CPC extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PC.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/Icon_pcpe.png"))); // NOI18N
        ...
        jTabbedPane1.addTab(bundle.getString("CPC.terCode2.TabConstraints.tabTitle"), terCode2); // NOI18N
        jTabbedPane1.addTab(bundle.getString("CPC.listaIconos1.TabConstraints.tabTitle"), listaIconos1); // NOI18N
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/SSD.png"))); // NOI18N
        jLabel10.setText(bundle.getString("CPC.jLabel10.text")); // NOI18N

        jLabel9.setForeground(new java.awt.Color(254, 254, 254));
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/HDD.png"))); // NOI18N
        jLabel9.setText(bundle.getString("CPC.jLabel9.text")); // NOI18N

        jLabel4.setForeground(new java.awt.Color(254, 254, 254));
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/wifi.png"))); // NOI18N
        jLabel4.setText(bundle.getString("CPC.jLabel4.text")); // NOI18N

        jLabel2.setForeground(new java.awt.Color(254, 254, 254));
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/ram.png"))); // NOI18N
        jLabel2.setText(bundle.getString("CPC.jLabel2.text")); // NOI18N

        jLabel8.setForeground(new java.awt.Color(253, 243, 243));
        jLabel8.setText(bundle.getString("CPC.jLabel8.text")); // NOI18N

        jLabel7.setBackground(new java.awt.Color(254, 254, 254));
        jLabel7.setForeground(new java.awt.Color(254, 254, 254));
        jLabel7.setText(bundle.getString("CPC.jLabel7.text")); // NOI18N
        ...
        jLabel2.getAccessibleContext().setAccessibleName(bundle.getString("CPC.jLabel2.AccessibleContext.accessibleName")); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/ubunBonito.png"))); // NOI18N

        jLabel12.setForeground(new java.awt.Color(254, 254, 254));
        jLabel12.setText(bundle.getString("CPC.jLabel12.text")); // NOI18N

        jLabel13.setForeground(new java.awt.Color(254, 254, 254));
        jLabel13.setText(bundle.getString("CPC.jLabel13.text")); // NOI18N
    ...
    private void jLabel3MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MousePressed
        ...
        if(encendido==0)
        {
         PC.setIcon(a);
         encendido=1;
         jLabel10.setText("25/256GB");

 
        jLabel9.setText("120GB/1T");

        jLabel4.setText("OrangeBox");


        jLabel2.setText("0/8GB");
    ...
    private void PCMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PCMouseEntered
       ...
       // PC.setToolTipText( "<html><img src=\""+getClass().getResource("/imagen/Icon_pcp.png")+"\"><p>holiiii<p></html>" );
        PC.setToolTipText( "<html><BODY BGCOLOR=\"#CCEEFF \"><h2><IMG SRC=\""+getClass().getResource("/imagen/original.png")+"\" ALIGN=\"left\">Intel Core i7-6700 3.4GHz Box</h2></br>"
                + "<h2><IMG SRC=\""+getClass().getResource("/imagen/ram.jpg")+"\" ALIGN=\"left\">Kingston HyperX Fury Blue DDR3 1600 PC3-12800 8GB CL10 - Memoria DDR3</h2>"
                + "<h2><IMG SRC=\""+getClass().getResource("/imagen/video.jpg")+"\" ALIGN=\"left\">MSI GeForce GTX 970 Gaming 4GB</h2>"
                + "<h2><IMG SRC=\""+getClass().getResource("/imagen/ssz.jpg")+"\" ALIGN=\"left\">Samsung 750 Evo SSD Series 120GB SATA3 </h2>"
                + "<h2><IMG SRC=\""+getClass().getResource("/imagen/placa.jpg")+"\" ALIGN=\"left\">Asrock Fatal1ty Z97X Killer/3.1 </h2>"
                + "<h2><IMG SRC=\""+getClass().getResource("/imagen/disco.jpg")+"\" ALIGN=\"left\">Seagate Barracuda 7200.14 1TB SATA3 </h2></BODY>\n" +
"</html>" );
